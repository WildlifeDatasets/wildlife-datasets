...
def prepare_bird_individual_id(
    root, new_root, k=20, transform=None, add_split=False, splitter=None, segmented=True, **kwargs
):
    if segmented:
        root = root + "Segmented"
...
def prepare_sea_turtle_id_2022_animal_clef_2025(
    root, new_root, k=1, transform=None, add_split=False, splitter=None, **kwargs
):
