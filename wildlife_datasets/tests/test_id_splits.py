...
splitters1_date = [splits.RandomProportion(seed=seed1)]
splitters2_all = [
...
splitters2_date = [splits.RandomProportion(seed=seed2)]
tol = 0.1
            ...
            for dataset in datasets:
                ...
                for idx_train1, idx_test1 in splitter.split(df):
                    ...
                    for id in set(df_train1[dataset.col_label]):
                        self.assertEqual(
                            len(df_train1[dataset.col_label] == id), len(df_train2[dataset.col_label] == id)
                        )
